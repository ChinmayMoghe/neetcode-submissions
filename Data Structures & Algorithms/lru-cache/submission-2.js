class LRUCache {
    ...
    constructor(capacity) {
        this.size = capacity;
        this.cache = new Map();
        this.#dll = new DLL(new Node(null),new Node(null)); 
    }
    ...
    get(key) {
        if(this.cache.has(key)) {
            ...
            this.#dll.remove(ref);
            this.#dll.insertAfter(this.#dll.head,ref);
    ...
    put(key, value) {
        if(this.cache.has(key)) {
            ...
            const LRUNode = this.#dll.remove(this.#dll.tail.prev);
...
// insertAfter(refNode, node) -> to be used to add most recently used
// insertBefore(refNod, node) -> to be used to add least recently used
