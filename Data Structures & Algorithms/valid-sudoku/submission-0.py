class Solution:
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        rows = [[0 for _ in range(0,len(board))] for _ in range(0,len(board))]
        cols = [[0 for _ in range(0,len(board))] for _ in range(0,len(board))]
        boxes = [[0 for _ in range(0,len(board))] for _ in range(0,len(board))]
